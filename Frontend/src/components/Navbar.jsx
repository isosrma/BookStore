...
function Navbar() {
  ...
  return (
    <>
  <div
  className={`   dark:bg-slate-500 dark:text-white  max-w-screen-2xl mx-auto container md:px-20 px-4 fixed top-0 left-0 right-0 z-50  ${
    sticky
...
>
  ...
  <div className='hidden md:block'>
    <label className="input grow outline-none *:">
